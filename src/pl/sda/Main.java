...
public class Main {
    public static void main(String[] args) {
        ...
        // zakładamy na początku, że najdłuższy poem to ten zerowy
        // algorytm szukania maksimum w tablicach
        ...
        System.out.println("Najdłuższy wiersz napisał: " + longestPoem.getCreator());
